  ...
  return (
    <>
      <SEOHead
        ...
        description="Explore our diverse photography portfolio featuring weddings, portraits, commercial photography, events, fashion and nature photography in Rajkot and Gujarat."
        keywords="photography portfolio, wedding portfolio, commercial photography, event photography, portrait gallery, photography samples, Rajkot photographer"
        image="https://res.cloudinary.com/rvstudioin/image/upload/v1/Portfolio/portfolio-og.jpg"
        url="/portfolio"
        type="CollectionPage"
      />
